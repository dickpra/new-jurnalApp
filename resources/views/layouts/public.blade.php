...
<head>
    ...
    <title>@yield('title', $settings->site_name ?? 'Journal Publishing Platform')</title>
            ...
            <div class="flex justify-between items-center h-14">
                ...
                <div class="hidden md:flex items-center space-x-6 text-sm font-semibold">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="px-5 py-2 bg-indigo-700 text-white rounded hover:bg-indigo-800 transition shadow-sm">Register</a>
                    @endauth
                </div>
            </div>
        </div>
